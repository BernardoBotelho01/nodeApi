...
router.post("/autenticacao", async (req: Request, res: Response) => {
  try {
...
router.get("/validar-token", verificarToken, async (req: Request, res: Response) => {
    return res.status(200).json({
...
router.put("/atualizar-senha", async (req: Request, res: Response) => {
  try {
